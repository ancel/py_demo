...
maillist = ['xuan.zhang@yulore.com']    # 接收者账号
#maillist = ['haibo.wang@yulore.com','xuan.zhang@yulore.com']    # 接收者账号
...
if __name__ == '__main__':
    ...
    for i in range(3,len(sys.argv)):
        attach_files.append(sys.argv[i])
    sendmail(maillist, subject, content, attach_files)
